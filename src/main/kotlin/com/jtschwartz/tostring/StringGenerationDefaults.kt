...
object StringGenerationDefaults {
	val exclusionSettings = object: ExclusionSettingsContract {
		...
		override var excludeNullAndUninitialized: Boolean = false
	...
	val sortSettings = object: SortSettingsContract {
		override var method: SortMethod = SortMethod.INITIAL
	}
		...
		attempt {
			...
			Properties().apply {
				...
				when (name as String) {
					...
					"tostring.exclude.null_and_uninit" -> exclusionSettings.excludeNullAndUninitialized = (value as String).equals("true", ignoreCase = true)
					...
					"tostring.sort.method"             -> sortSettings.method = SortMethod.valueOf(value as String)
